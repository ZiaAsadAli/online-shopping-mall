...
////INSERT QUERY
         $mysqli_conn->query("INSERT INTO products_list(product_name, product_desc, 
					...
					product_image, product_image1, product_image2,product_price, category, brands,gender,keyword,code,status,add_by)
					
					VALUES ('$Pname','$desc','$img1','$img2','$img3','$price','$cname','$bname','$gen','$keyword','".genRndString()."','Autherized','$ademl')");
