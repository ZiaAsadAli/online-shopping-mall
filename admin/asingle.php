	  ...
	  <div class="single_top">
	       <div class="col-md-9 single_right">
				  ...
				  <div class="desc1 span_3_of_2">
				    ...
				    <div class="btn_form btnSearch">
						<td>
					 <a class="btnDeleteAction" onclick="return confirm('Are You Sure To Authorized The Product')" href="authorize.php?id=<?php echo $Id ?>">Authorize</a>
					</td>	
					 </div>
