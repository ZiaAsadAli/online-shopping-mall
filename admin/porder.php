...
require_once("perpage.php");
		...
		foreach($_POST["search"] as $k=>$v){
			if(!empty($v)) {
				...
				switch($k) {
					case "name":
						$sname = $v;
						$queryCondition .= "status='Processed' and order_no LIKE '%" . $v . "%'";
						break;
					}
			}
		}
	...
	$sql1 = "SELECT  * FROM cart where status='Processed' " ;
	$href = 'porder.php';					
...
<div class="col-md-9">
	<div class="mens-toolbar">
          <div class="sort">
			...
			<form name="frmSearch" method="post" action="porder.php">
          ...
          <tr>
					...
					<td>
					 <a title="Click To View Detail" class="btnDeleteAction" onclick="return confirm('Have Product Deliver Successfully')" href="compprocess.php?orid=<?php echo $result[$k]["id"]; ?>">Process</a>
					</td>
					</tr>
					<?php
						}
