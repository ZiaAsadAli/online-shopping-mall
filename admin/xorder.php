...
require_once("perpage.php");
		...
		foreach($_POST["search"] as $k=>$v){
			if(!empty($v)) {
				...
				switch($k) {
					case "name":
						$sname = $v;
						$queryCondition .= "status='Cancel' and order_no LIKE '%" . $v . "%'";
						break;
					}
			}
		}
	...
	$sql1 = "SELECT * FROM complete where status='Cancel' " ;
	$href = 'xorder.php';					
...
<div class="col-md-9">
	<div class="mens-toolbar">
          <div class="sort">
			...
			<form name="frmSearch" method="post" action="xorder.php">
			...
			<p>
				...
				<?php
					...
					?>
          <tr>
					<td><a title="Click To View Detail" href="order_details3.php?ordercode=<?php echo $result[$k]["order_no"]; ?>"><?php echo $result[$k]["order_no"]; ?></a></td>
