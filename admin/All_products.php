...
require_once("perpage.php");
		...
		foreach($_POST["search"] as $k=>$v){
			if(!empty($v)) {
				...
				switch($k) {
					case "name":
						$sname = $v;
						$queryCondition .= "status='autherized' AND code LIKE '%" . $v . "%'";
						break;
	...
	$sql1 = "SELECT * FROM products_list  where status='autherized' " ;
...
<div class="col-md-9">
	<div class="mens-toolbar">
          <div class="sort">
			...
			<form name="frmSearch" method="post" action="All_products.php">
