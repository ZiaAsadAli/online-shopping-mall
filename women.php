...
$(document).ready(function() {
	$("#results").load("wfetch_pages.php");  //initial page number to load
	$(".pagination").bootpag({
	   ...
	   maxVisible: 5 
		...
		$("#results").load("wfetch_pages.php", {'page':num});
	});
...
<div class="col-md-9">
     	    ...
     	    <div class="clearfix"></div>
					...
					<div class="tab-content">
							...
							<div class="txt-heading">Shopping Cart <a id="btnEmpty" href="women.php?action=empty">Empty Cart</a> </div>
					<?php
											...
											<?php		
												foreach ($_SESSION["cart_item"] as $item){
													?>
															...
															<td><a href="women.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction">Remove Item</a></td>
