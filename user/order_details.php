...
include("config.inc.php"); 
	...
	$code=$_GET['ordercode'];
	$result=$mysqli_conn->query("SELECT * FROM complete WHERE order_no='$code'");
	$item_total=0;
?>
<html>
<head>
			   ...
			   <div class="txt-heading">Order Details  </div>
				   <table cellpadding="10" cellspacing="1" class="carttable table table-responsive table-hover table-bordered" width="1px">
								<tbody>
											...
											<th><strong>Order Delivery Date</strong></th>
				...
				?>
					...
					<?php
							...
							?>
							<tr>
								<td colspan="8" align=right><strong>Total:</strong> <?php echo $item_total; ?></td>
