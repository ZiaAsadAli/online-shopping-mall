...
$useremail=$_SESSION['usaemail'];
		...
		foreach($_POST["search"] as $k=>$v){
			if(!empty($v)) {
				...
				switch($k) {
					case "name":
						$sname = $v;
						$queryCondition .= "status='Cancel' and useremail='$useremail' and order_no LIKE '%" . $v . "%'";
						break;
					}
			}
		}
	...
	$sql1 = "SELECT * FROM complete where status='Cancel'and useremail='$useremail' " ;
	$href = 'xorder.php';					
