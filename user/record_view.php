	...
	<div class="mens-toolbar">
          <div class="sort">
         	...
         	<div class="col_1_of_single1"> 
				  ...
				  <a href="new_order.php"><button type="button" class="btn btn-default">My New Orders</button></a>
				  <a href="corder.php"><button type="button" class="btn btn-default">All Completed Orders</button></a>
				  <a href="xorder.php"><button type="button" class="btn btn-default">All Cancel Orders</button></a>
