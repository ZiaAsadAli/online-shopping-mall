...
require_once("perpage.php");
	...
	$orderby = " Where brands='$bdn' ORDER BY product_id desc"; 
...
<div class="col-md-9">
	<div class="mens-toolbar">
          <div class="sort">
			...
			<form name="frmSearch" method="post" action="myproducts.php">
			...
			<p>
				...
				<?php
					...
					?>
          <tr>
					<td><a rel="facebox" title="Click To View Detail" href="user_details.php?username=<?php echo $result[$k]["code"]; ?>"><?php echo $result[$k]["code"]; ?></a></td>
