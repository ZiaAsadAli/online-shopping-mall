...
require_once("dbcontroller.php");
   ...
   if (isset($_POST['search'])){
	$_SESSION['w']=$_POST['userquery'];
	$_SESSION['d']=$_POST['userquery'];
	
   }
   else{
  $_SESSION['w']=$_SESSION['d'];
   }
...
$(document).ready(function() {
	$("#results").load("rfetch_pages.php");  //initial page number to load
	$(".pagination").bootpag({
	   ...
	   maxVisible: 5 
		...
		$("#results").load("rfetch_pages.php", {'page':num});
	});
...
<div class="col-md-9">
     	    ...
     	    <div class="clearfix"></div>
					...
					<div class="tab-content">
							...
							<div class="txt-heading">Shopping Cart <a id="btnEmpty" href="results.php?action=empty">Empty Cart</a> </div>
					<?php
											...
											<?php		
												foreach ($_SESSION["cart_item"] as $item){
													?>
															...
															<td><a href="results.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction">Remove Item</a></td>
